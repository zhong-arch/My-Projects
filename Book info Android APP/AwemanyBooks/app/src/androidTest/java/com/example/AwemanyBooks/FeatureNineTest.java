...
public class FeatureNineTest {
    ...
    public void testUserStory23(){
        clickOnBooks(5);
        openNavFragment(R.id.nav_topbooks, "Top Viewed Books");
        checkIfBooksInView(5);
    }
    public void clickOnBooks(int amountOfBooksToClick){
        for(int i=0; i< amountOfBooksToClick; i++) {
            clickOnBook(i);
            pressBack();
        }
    }
    public void checkIfBooksInView(int amountOfBooksToCheck){
        for(int i=0; i< amountOfBooksToCheck; i++) {
            ...
            String isbn = ("ISBN: "  + bookList.get(i).getIsbn());
