...
public class FeatureFourTest {
    ...
    public void changePassword(String newPassword){
        ...
        onView(withId(R.id.oldPass)).perform(ViewActions.typeText(password),ViewActions.closeSoftKeyboard());
        onView(withId(R.id.newPass)).perform(ViewActions.typeText(newPassword),ViewActions.closeSoftKeyboard());
        onView(withId(R.id.change_password_submit)).perform(ViewActions.click());
        onView(withText("Passowrd Change Success!")).check(ViewAssertions.matches(isDisplayed()));
    }
}