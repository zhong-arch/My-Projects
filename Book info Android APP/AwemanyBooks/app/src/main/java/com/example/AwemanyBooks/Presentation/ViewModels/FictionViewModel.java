...
public class FictionViewModel extends AndroidViewModel {
    private AccessBooks accessBooks;
    private BookList allBooks;

    final private String categoryName = "Fiction";

    public FictionViewModel(@NonNull Application application) {
        super(application);
